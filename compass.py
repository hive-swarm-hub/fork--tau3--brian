...
def canonicalize_json_args(value) -> str:
    ...
    BUG FIX (junjie post #27): the original used compact separators (",",":")
    producing '{"key":"val"}', but the oracle expects standard json.dumps()
    spacing '{"key": "val"}'. Every canonicalized call was a guaranteed
    literal-string mismatch. Fixed to use default separators (", ", ": ").
    """
